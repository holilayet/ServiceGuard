...
const contractABI = require("../artifacts/contracts/Serviceguard.sol/Serviceguard.json").abi;

program
    .name("serviceguard-cli")
    .description("CLI tool for Serviceguard smart contract")
    .version("1.0.0");
